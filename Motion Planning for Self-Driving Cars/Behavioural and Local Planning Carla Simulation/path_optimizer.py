...
class PathOptimizer:
    ...
    def thetaf(self, a, b, c, d, s):
        ...
        thetas = polyval(array([d / 4, c / 3, b / 2, a, 0]), s)
        return thetas
        # ------------------------------------------------------------------
    ...
    def sample_spiral(self, p):
        ...
        x_points = scipy.integrate.cumtrapz(cos(t_points), s_points, initial=0)
        y_points = scipy.integrate.cumtrapz(sin(t_points), s_points, initial=0)
